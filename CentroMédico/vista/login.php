...
<body>
	<form class="login" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post" name="login">
        ...
        <input type="text" name="usuario"placeholder="Usuario" class="bordes" autofocus autocomplete="off"/>
        <input type="password" name="password" placeholder="Contraseña" class="bordes" autocomplete="off"/>
