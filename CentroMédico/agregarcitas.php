...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($mensaje==''){
		...
		'INSERT INTO citas (idcita, citfecha,cithora,citPaciente,citMedico,citConsultorio,citestado,citobservaciones) 
		values(null, :fecha,:hora,:paciente,:medico,:consultorio,:estado,:observaciones)');
